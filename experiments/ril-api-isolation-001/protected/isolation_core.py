"""Offline core for RIL-API-ISOLATION-001: canaries, prompts, payload rules,
...
EXPERIMENT = "RIL-API-ISOLATION-001"
...
# flags, assistant-role history) is cross-request state and fails closed.
ALLOWED_PAYLOAD_KEYS = frozenset({"model", "messages", "temperature", "max_tokens"})
...
def aggregate(pairs: list[PairRecord]) -> str:
    ...
    return "PASS_RIL_API_ISOLATION_001_STATELESS_CANARY_BOUNDARY"
