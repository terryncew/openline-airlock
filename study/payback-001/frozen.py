"""PAYBACK-001 frozen study constants.
...
# Frozen base: origin/study/econ-002 HEAD at branch creation.
BASE_SHA = "9ccd19d853083b97f8aed4d30d8ff00c553a1f12"

# --- Corpus / horizon (from scripts/gen_pb1_corpus.py) ---
...
# PREREGISTRATION.md; null recalibrated at H=450.
...
# Filled by scripts/gen_pb1_corpus.py; verified by offline().
...
# --- Empirical-null terminal margin (from scripts/null_calibration.py) ---
...
#  simulated 700-task horizons exceeded the frozen terminal margin."
...
# from making the 700-task horizon and the $25 budget meaningless.
...
# Invocation-ID taxonomy (frozen prefixes).
P_PRE, P_DISC, P_PROP = "pb1-pre", "pb1-d", "pb1-p"
P_PROMO_P, P_PROMO_C = "pb1-m-P", "pb1-m-C"
P_OP_C, P_OP_T = "pb1-o-C", "pb1-o-T"
