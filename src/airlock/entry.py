...
PUBLIC_COMMANDS = (
    ...
    ("improve", "Compound measured improvements on an isolated branch."),
    ("nightshift", "Let Hermes work unattended behind the same independent gate."),
...
def _help_text() -> str:
    ...
    lines.extend([
        ...
        "  airlock improve --objective .airlock/objective.json",
        "  airlock nightshift --objective .airlock/objective.json",
        "  airlock inbox",
        "  airlock review",
        "",
